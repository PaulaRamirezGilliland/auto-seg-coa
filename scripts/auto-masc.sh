...
python3 ${segm_path}/src/run_monai_atunet_masc.py ${main_dir}/ ${monai_check_path}/ masked-stack-info.json ${main_dir}/monai-segmentation-results-masc ${monai_lab_num}
